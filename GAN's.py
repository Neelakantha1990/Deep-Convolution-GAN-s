...
# Loading the dataset
dataset = dset.CIFAR10(root = '/Users/neel/Computer_Vision_A_Z_Template_Folder/Module 3 - GANs/data', download = True, transform = transform) # We download the training set in the ./data folder and we apply the previous transformations on each image.
...
for epoch in range(25): # We iterate over 25 epochs.
    ...
    for i, data in enumerate(dataloader, 0): # We iterate over the images of the dataset.
        ...
        if i % 100 == 0: # Every 100 steps:
            vutils.save_image(real, '%s/real_samples.png' % "/Users/neel/Computer_Vision_A_Z_Template_Folder/Module 3 - GANs/results", normalize = True) # We save the real images of the minibatch.
            fake = netG(noise) # We get our fake generated images.
            vutils.save_image(fake.data, '%s/fake_samples_epoch_%03d.png' % ("/Users/neel/Computer_Vision_A_Z_Template_Folder/Module 3 - GANs/results", epoch), normalize = True) # We also save the fake generated images of the minibatch.